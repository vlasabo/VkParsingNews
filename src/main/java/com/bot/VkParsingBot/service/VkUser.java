...
@Component
//TODO: опять же, предлагаю отдельно пообщаться по этому классу.
// Сначала хотелось бы услышать твое видение его логики. Но сразу скажу:
// ты тут сделал почти классический God object
